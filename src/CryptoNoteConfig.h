...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x35d65c;
...
const char     CRYPTONOTE_NAME[]                             = "LOTS";
...
const int      P2P_DEFAULT_PORT                              = 14278;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 14277;
